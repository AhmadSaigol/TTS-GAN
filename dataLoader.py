...
if __name__ == "__main__":
    ...
    number_of_samples = 50#10000
    window_length=24
    trig_fnt = 'cosine'#'sine'  

    dataset = train_set = unimib_load_dataset(incl_xyz_accel = True, incl_rms_accel = False, incl_val_group = False, is_normalize = False, one_hot_encode = False, data_mode = 'Train', single_class = True, class_name ='Running', augment_times=None)
    ...
    ax[1].set_title('accel_y')
    ax[2].set_title('accel_z')
    
    plt.savefig("logs/running/unnorm.png")
