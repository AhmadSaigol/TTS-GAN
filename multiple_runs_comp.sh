...
--channels 8 \
--seq_len 300 \
--exp_name test_particle_data_unnorm \
--model_type informer
...
--rank 0 \
--dataset stock_data \
--data_path "/home/ahmad/Documents/Masters - TUHH/Research Project/timeGAN/data/stock_data.csv" \
--bottom_width 8 \
--max_iter 5 \
--gen_model my_gen \
--dis_model my_dis \
...
--ema_warmup 0.1 \
--ema 0.9999 \
--class_name stock_data \
--channels 6 \
--seq_len 24 \
--exp_name test_stock_data_minmax \
--is_normalize \
--norm_type MinMax \
--norm_level full \
--model_type informer 
...
--channels 6 \
--seq_len 24 \
--exp_name test_stock_data_standardscaler \
--is_normalize \
